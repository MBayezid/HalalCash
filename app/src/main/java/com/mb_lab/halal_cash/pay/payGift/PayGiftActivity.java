...
public class PayGiftActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewLoadingAnimation = new ViewLoadingAnimation(PayGiftActivity.this);
        userSessionManager = new UserSessionManager(this);

        emptyAdsList = findViewById(R.id.emptyAdsList);
        recyclerView = findViewById(R.id.recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(PayGiftActivity.this));
